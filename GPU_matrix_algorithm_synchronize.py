...
if __name__ == "__main__":
    ...
    print(f"max_work_item_sizes:{max_work_item_sizes}")
    ...
    for scale in DEFAULT_SCALES:
        ...
        for t in range(3):
            ...
            event =cl.enqueue_nd_range_kernel(queue=queue, kernel=kernel, global_work_size=A.shape, local_work_size=(min(scale, 4), 1))
